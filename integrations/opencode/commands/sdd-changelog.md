---
description: "Genera un CHANGELOG.md a partir de los cambios archivados en openspec/changes/archive/"
agent: sdd-orchestrator
---
You must execute this command following the strict transactional loop:
1. Initialize the transaction using `tx_begin`.
2. Delegate execution to the sub-agent by calling `delegate_task` with `sub_agent_skill: "{{SKILLS_PATH}}/sdd-changelog/SKILL.md"`.
