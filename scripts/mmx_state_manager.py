...
STATE_FILE = ".memex/changes/{change}/state.ini"
LOCK_FILE = ".memex/changes/{change}/.lock"
WRITE_LOCK_FILE = ".memex/changes/{change}/.write-lock"
TASKS_FILE = ".memex/changes/{change}/tasks.md"
DEFAULT_TTL = 1800
...
def cmd_commit(args):
    def _do():
        ...
        # ejecute /mmx-checkpoint manualmente.
        auto_summary = (
...
def cmd_check_completion(args):
    ...
    le pedíamos al LLM (Paso 3a de mmx-checkpoint). Un modelo débil cuenta mal
