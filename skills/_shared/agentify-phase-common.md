...
Si necesitás un checkpoint más rico (con `archivos_modificados`, `decisiones_clave`), ejecutá `/agentify-checkpoint` después del COMMIT.
...
> Seguí el protocolo de transacción definido en `skills/_shared/agentify-phase-common.md`
