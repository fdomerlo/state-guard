...
```sh
sh skills/agentify-skill-registry/scan.sh
```

El script:

- Escanea `$HOME/.skills-custom` y `./skills-custom`
- Ignora directorios que comienzan con `agentify-` y `_shared`
