...
Si existe `.state-guard/specs/{dominio}/spec.md`, léela para entender el comportamiento ACTUAL. Tus specs delta describen los CAMBIOS a ese comportamiento.
...
- Aplicar cualquier `rules.specs` de `.state-guard/config.yaml`
