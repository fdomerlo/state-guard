...
name: review
description: >
  Realiza auditoría estática de código comparando contra especificaciones. A diferencia de verify (que ejecuta tests), review analiza el código sin ejecutarlo.
