...
description: >
  ...
  Disparador: Cuando el usuario ejecuta /agentify-changelog o quiere generar un changelog desde los cambios archivados.
license: MIT
metadata:
...
Aún no hay cambios archivados. Los cambios aparecerán aquí después de ser archivados con /agentify-archive.
```
