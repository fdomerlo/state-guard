---
name: agentify-design
description: >
  Crea el documento de diseño técnico con decisiones de arquitectura y enfoque.
  Disparador: Cuando el usuario ejecuta /agentify-design para escribir o actualizar el diseño técnico de un cambio.
license: MIT
metadata:
...
### Próximo Paso
Listo para tareas (`/agentify-tasks`).
```
