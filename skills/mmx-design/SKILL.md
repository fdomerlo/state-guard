...
description: >
  ...
  Disparador: Cuando el usuario ejecuta /mmx-design para escribir o actualizar el diseño técnico de un cambio.
license: MIT
metadata:
...
**Ubicación**: .memex/changes/{nombre-del-cambio}/design.md
...
- Aplicar cualquier `rules.design` de `.memex/config.yaml`
