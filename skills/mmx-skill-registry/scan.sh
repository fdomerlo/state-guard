...
# Uso: sh skills/mmx-skill-registry/scan.sh

GLOBAL_DIR="$HOME/.skills-custom"
LOCAL_DIR="./skills-custom"
OUTPUT="./.memex/skill-registry.md"
...
Generado automáticamente por mmx-skill-registry/scan.sh
...
if [ "$found" -eq 0 ]; then
  echo "_No se encontraron skills adicionales a las fases._" >> "$OUTPUT"
fi
