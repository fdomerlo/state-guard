...
description: >
  ...
  Disparador: Cuando el usuario ejecuta /mmx-explore para reflexionar sobre una funcionalidad, investigar el código base o aclarar requisitos.
license: MIT
metadata:
...
Si hay un nombre de cambio (es decir, esta exploración forma parte de `/mmx-new`), guarda el análisis en:
...
Si no se proporcionó nombre de cambio (`/mmx-explore` independiente), omite la creación del archivo — solo devuelve el análisis.
