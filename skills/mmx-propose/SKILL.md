...
description: >
  ...
  Disparador: Cuando el usuario ejecuta /mmx-propose para crear o actualizar una propuesta de cambio.
license: MIT
metadata:
...
Si `.memex/specs/` tiene specs relevantes, léelas para entender el comportamiento actual que este cambio podría afectar.
...
**Ubicación**: .memex/changes/{nombre-del-cambio}/proposal.md
...
### Próximo Paso
Listo para specs (`/mmx-spec`) o diseño (`/mmx-design`).
```
...
- Aplicar cualquier `rules.proposal` de `.memex/config.yaml`
