...
name: mmx-review
description: >
  Realiza auditoría estática de código comparando contra especificaciones. A diferencia de mmx-verify (que ejecuta tests), mmx-review analiza el código sin ejecutarlo.
...
La diferenciación clave con `mmx-verify` es:

- **mmx-verify**: Análisis dinámico — ejecuta tests y build, valida comportamiento en runtime
- **mmx-review**: Análisis estático — compara estructura de código contra requisitos documentados
...
artefactos = .memex/changes/{cambio}/
...
- **memex**: Guardar en `.memex/changes/{nombre-del-cambio}/review-report.md`
