...
description: >
  ...
  Disparador: Cuando el usuario ejecuta /mmx-new para iniciar un cambio.
license: MIT
metadata:
...
### Paso 2: Ejecutar mmx-explore (Transacción 1)

Cargá `skills/mmx-explore/SKILL.md` y ejecutá inline:

1. Ejecutar la exploración

### Paso 3: Ejecutar mmx-propose (Transacción 2)

Cargá `skills/mmx-propose/SKILL.md` y ejecutá inline:
