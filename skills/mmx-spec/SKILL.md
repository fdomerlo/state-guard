...
description: >
  ...
  Disparador: Cuando el usuario ejecuta /mmx-spec para escribir o actualizar especificaciones de un cambio.
license: MIT
metadata:
...
Si existe `.memex/specs/{dominio}/spec.md`, léela para entender el comportamiento ACTUAL. Tus specs delta describen los CAMBIOS a ese comportamiento.
...
- Aplicar cualquier `rules.specs` de `.memex/config.yaml`
