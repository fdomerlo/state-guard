...
name: agentify-split
description: >
  Divide proposals monolíticas en sub-cambios manejables. Analiza una proposal grande y genera un plan de partición con comandos /agentify-new sugeridos.
...
- **Comando sugerido**: `/agentify-new {nombre-sub-cambio-1}`

### Sub-cambio 2: {nombre-sub-cambio-2}
- **Objetivos abarcados**: {lista de objetivos originales}
- **Justificación**: {por qué se agrupan juntos}
- **Comando sugerido**: `/agentify-new {nombre-sub-cambio-2}`
...
|------------|----------|---------------|---------|
| {nombre}   | {lista}  | {por qué}     | /agentify-new {nombre} |
