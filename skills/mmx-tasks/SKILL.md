...
description: >
  ...
  Disparador: Cuando el usuario ejecuta /mmx-tasks para crear el checklist de tareas.
license: MIT
metadata:
...
1. **Specs delta** — `.memex/changes/{nombre-del-cambio}/specs/`
2. **Diseño** — `.memex/changes/{nombre-del-cambio}/design.md`
...
### Próximo Paso
Listo para implementar (`/mmx-apply`).
```
...
- Aplicar cualquier `rules.tasks` de `.memex/config.yaml`
