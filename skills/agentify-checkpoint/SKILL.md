...
description: >
  ...
  Disparador: Cuando el usuario ejecuta /agentify-checkpoint para guardar estado, o automáticamente post-COMMIT.
license: MIT
metadata:
...
```text
Fuente primaria:   Tabla "### Archivos Modificados" del último resumen de agentify-apply
