...
description: >
  ...
  restaurar el entorno git al estado anterior. Disparador: Cuando el usuario ejecuta /mmx-rollback para revertir un cambio.
license: MIT
metadata:
...
Skill responsable de **revertir completamente un cambio activo** en el DAG del agente. Skill de emergencia que purga la carpeta del cambio y restaura el entorno git a su estado anterior.
...
- La carpeta .memex/changes/{nombre}/
...
- Ubicación previa: .memex/changes/{nombre}/
```
