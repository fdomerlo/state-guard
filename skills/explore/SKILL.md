...
Si hay un nombre de cambio (es decir, esta exploración forma parte de `/new`), guarda el análisis en:
...
Si no se proporcionó nombre de cambio (`/explore` independiente), omite la creación del archivo — solo devuelve el análisis.
