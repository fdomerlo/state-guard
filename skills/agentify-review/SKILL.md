---
name: agentify-review
description: >
  Realiza auditoría estática de código comparando contra especificaciones. A diferencia de agentify-verify (que ejecuta tests), agentify-review analiza el código sin ejecutarlo.
...
La diferenciación clave con `agentify-verify` es:

- **agentify-verify**: Análisis dinámico — ejecuta tests y build, valida comportamiento en runtime
- **agentify-review**: Análisis estático — compara estructura de código contra requisitos documentados
