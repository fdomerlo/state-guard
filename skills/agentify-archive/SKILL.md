---
name: agentify-archive
description: >
  Sincroniza especificaciones delta con las especificaciones principales y archiva un cambio completado.
  Disparador: Cuando el usuario ejecuta /agentify-archive para archivar un cambio después de la implementación y verificación.
license: MIT
metadata:
