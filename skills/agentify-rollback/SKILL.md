---
name: agentify-rollback
description: >
  Skill de emergencia para revertir un cambio activo. Purgar la carpeta del cambio y
  restaurar el entorno git al estado anterior. Disparador: Cuando el usuario ejecuta /agentify-rollback para revertir un cambio.
license: MIT
metadata:
