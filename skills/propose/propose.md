...
Si `.state-guard/specs/` tiene specs relevantes, léelas para entender el comportamiento actual que este cambio podría afectar.
...
**Ubicación**: .state-guard/changes/{nombre-del-cambio}/proposal.md
...
### Próximo Paso
Listo para specs (`/spec`) o diseño (`/design`).
```
...
- Aplicar cualquier `rules.proposal` de `.state-guard/config.yaml`
