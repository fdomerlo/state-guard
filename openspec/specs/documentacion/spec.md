...
## Delta: actualizacion-docs-agent-first (2026-04-06)
...
(Anteriormente: El documento mencionaba estas herramientas como opciones de integración)
...
- GIVEN la documentación referencia a archivos inexistentes
- WHEN se ejecuta el cambio
