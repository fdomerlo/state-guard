...
| `/sdd-skill-registry` | Escanea los directorios global (`$HOME/.skills-custom`) y local (`./skills-custom`) de skills y actualiza el repositorio local. Útil para añadir o descubrir nuevas skills. | Skill Directa |
