# Orquestador - Specs Driven Development - Reglas para VS Code Copilot
...
Mantén este prompt ligero. Utiliza los archivos de convención compartidos bajo `.vscode/skills/_shared/` (o tu ruta global):
