# Orquestador - Specs Driven Development - Reglas para Claude
...
Mantén este prompt ligero. Utiliza los archivos de convención compartidos bajo `~/.claude/skills/_shared/` (o tu ruta global):
