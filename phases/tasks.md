...
1. **Specs delta** — `.state-guard/changes/{nombre-del-cambio}/specs/`
2. **Diseño** — `.state-guard/changes/{nombre-del-cambio}/design.md`
...
- Aplicar cualquier `rules.tasks` de `.state-guard/config.yaml`
